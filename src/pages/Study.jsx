                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-auto">
                            {Object.keys(q.options).sort().map(opt => {
                                ...
                                return (
                                    <div key={opt} className={`p-6 rounded-2xl flex items-center gap-4 transition-colors ${isCorrect ? 'border border-green-500/50 bg-green-500/10 shadow-[0_0_20px_rgba(34,197,94,0.1)]' : 'border border-white/10 bg-white/5 opacity-70'}`}>
